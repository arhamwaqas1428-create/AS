...
interface ExpenseFormProps {
  onAdd: (expense: { name: string; amount: number; category: Category; description: string }) => void;
}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="bg-black border-zinc-800 focus-visible:ring-primary min-h-[100px]"
            />
          </div>
